...
use App\Filament\Manager\Resources\SubordinateResource\Pages;
use App\Filament\Manager\Resources\SubordinateResource\RelationManagers;
use App\Models\User;
use Filament\Forms;
...
class SubordinateResource extends Resource
{
    ...
    public static function table(Table $table): Table
{
    ...
    {
        return [
            'index' => Pages\ListSubordinates::route('/'),
            'create' => Pages\CreateSubordinate::route('/create'),
            'edit' => Pages\EditSubordinate::route('/{record}/edit'),
        ];
    }
